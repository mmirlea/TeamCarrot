...
<link href="<c:url value='/resources/css/myProfileStyle.css?esdsd'/>"
	rel="stylesheet" />
<script
...
<body>
	<div class="wrap">
		<form enctype="multipart/form-data"
			action="<c:url value='/mypage/modify'/>" method="post">
			<div class="container">
				<div class="divProfile">
						...
						<div class="divUserImg">
							<div class="btnUserImg">
								<c:choose>
									...
									<c:otherwise>
										<img src="/proimg/${dto.m_proimg}" lt="프로필 사진">
									</c:otherwise>
								</c:choose>
					...
					<div class="divNicNm">
						<div class="divText">
							<div id="uploadImgBtn" style="display: none">
								<label for="imgMod">사진 올리기</label><input type="file" id="imgMod"
									name="imageFile" class="imgMod">
							</div>
							<input type="text" id="m_nicknm" name="m_nicknm" class="m_nicknm"
								value="${dto.m_nicknm}" style="display: none">
							<button type="submit" class="modBtn" id="modBtn"
								style="display: none">수정확인</button>
						</div>
						<div class="divBtn">
				...
				<div class="divSecurity">
					...
					<div class="divSetPw">
						<div class="divText">
							...
							<p>비밀번호</p>
							<div id="divNowPw" style="display: none">
								&nbsp&nbsp&nbsp 현재 비밀번호&nbsp<input type="password" id="nowPw">
								<button type="button" id="nowPwValid">확인</button>
								<i id="nowPwErr" style="display: none">잘못된 비밀번호 입니다.</i>
							</div>
							<div id="divModPw" style="display: none">
								&nbsp&nbsp&nbsp 수정할 비밀번호&nbsp<input type="password" id="modPw"
									onblur="checkPw()"> 비밀번호 확인<input type="password"
									id="modPw2" name="m_pw">
								<button type="button" class="modBtn2" id="modBtn2">수정확인</button>
								<div id="modErr1">
									<i>&nbsp&nbsp&nbsp영문/숫자/특수문자 8~14자리 </i><i id="modErr2"
										style="display: none">&nbsp&nbsp&nbsp 비밀번호가 일치하지 않습니다. </i>
								</div>
							</div>
							<div id="modFail" style="display: none">
								<i>비밀번호 변경 실패</i>
							</div>
				...
				<div class="divLocal">
					...
					<div class="divSetLocal">
						<div class="divSel">
							...
							</select> <input type="text" name="m_addr1" id="m_addr1"
								style="display: none"> <select name="town" class="town">
							...
							</select> <input type="text" name="m_addr2" id="m_addr2"
								style="display: none">
						</div>
