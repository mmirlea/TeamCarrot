...
public class ProductDTO {
	...
	public String getP_likeYN() {
		return p_likeYN;
	}

	public void setP_likeYN(String p_likeYN) {
		this.p_likeYN = p_likeYN;
	}
	...
	public String toString() {
		return "ProductDTO [p_menu=" + p_menu + ", p_num=" + p_num + ", p_cate=" + p_cate + ", p_email=" + p_email
				...
				+ p_buyemail + ", p_hiddenyn=" + p_hiddenyn + ", p_img=" + p_img + ", p_likeYN=" + p_likeYN
				+ ", userDTO=" + userDTO + ", likeyDTO=" + likeyDTO + ", fileUpload_p=" + fileUpload_p + "]";
	}
